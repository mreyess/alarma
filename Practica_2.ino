...
#define alarma 12     // Definimos el pin por el cual sonara la alarma al activarse la puerta
...
void setup() {        
  ...
  attachInterrupt(digitalPinToInterrupt(2), abrePuerta, LOW); //Señalamos que cuando la puerta se abra(es decir, que el red switch se active) entonces ejecute la interrupcion de hardware abrePuerta
...
void abrePuerta(){
  // Ordenamos que miestras la puerta este abierta suene la alarma y que al mismo tiempo el foco parpadee
